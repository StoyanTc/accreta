...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_accreta_TDigest_nativeIdentity(_env: JNIEnv, _class: JClass) -> jlong {
    into_handle(TDigest::identity())
}

#[unsafe(no_mangle)]
pub extern "system" fn Java_com_accreta_TDigest_nativeUpdateInPlace(_env: JNIEnv, _class: JClass, handle: jlong, value: jdouble) {
    let digest: &mut TDigest = unsafe { borrow_mut(handle) };
    digest.update_in_place(value);
}

#[unsafe(no_mangle)]
pub extern "system" fn Java_com_accreta_TDigest_nativeMergeInPlace(_env: JNIEnv, _class: JClass, handle: jlong, other_handle: jlong) {
...
#[unsafe(no_mangle)]
pub extern "system" fn Java_com_accreta_TDigest_nativeQuantile(_env: JNIEnv, _class: JClass, handle: jlong, q: jdouble) -> jdouble {
    let digest: &TDigest = unsafe { borrow(handle) };
    digest.quantile(q)
}

#[unsafe(no_mangle)]
pub extern "system" fn Java_com_accreta_TDigest_nativeDrop(_env: JNIEnv, _class: JClass, handle: jlong) {
