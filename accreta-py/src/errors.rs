...
create_exception!(
    ...
    IngestError,
    PyException,
    "Raised when ingesting a sample fails schema validation (wrong measure count/type, or wrong dimension count)."
);
create_exception!(
    accreta,
    SchemaError,
    PyException,
    "Raised when a Schema fails to build, or a query references an invalid measure."
);
